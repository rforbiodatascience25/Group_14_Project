...
ggplot(data_pacific_yearly,
       ...
       labs(x = "Year", y = "Mean % Bleaching", title = "Mean Coral Bleaching per Year in the Pacific Ocean"
        ) +
        theme_minimal(base_size = 12) +
        theme(
        axis.text.x = element_text(angle = 45, hjust = 1)
...
We make a linear model to extract some information about the linear fit:
