...
data_pacific_yearly <- reef_clean |> 
  filter(Ocean == "Pacific") |>            # keep only Pacific Ocean
...
ggplot(data_pacific_yearly,
  ...
  # Regression line (now aligned!)
  geom_smooth(method = "lm",
              se = FALSE,
              color = "red",
              linewidth = 1.3) +
  
  # Limit y-axis to 0–25%
  scale_y_continuous(limits = c(0, 7)) +
  
  # Make x-axis show whole years nicely
...
In the pacific ocean, the average bleaching has increased over the years...

## Conclusion

Coral bleaching is a global issue and requires samples from around the world, resulting in enormous data sets. To evaluate some of the findings from these many data points from 2002-2017 R has been a good tool.
